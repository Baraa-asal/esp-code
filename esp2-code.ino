...
const char* ssid ="Brrr";
const char* password ="Hamad19966";
int wifiLedPort = 14;
int serverLedPort = 12;
const String id = "ESP-B";
float counter = 0;
...
String loadsNames [] = {"Loadb1", "Loadb2", "Loadb3", "Loadb4", "Loadb5", "Loadb6", "Loadb7", "Loadb8", "Loadb9", "Loadb10"};
float loadsPower [] = {22.5, 12.5, 21.5, 12.5, 10, 7, 15, 3, 13, 14.5};
int pins [] = {13, 15, 2, 4, 5, 18, 19, 21, 22, 23};

bool statuses [] = {true,true,true,true,true,true,true,true,true,true};
