...
int wifiLedPort = 12;
int serverLedPort = 13;
const String id = "ESP-C";
float counter = 0;
...
String loadsNames [] = {"Loadc1", "Loadc2", "Loadc3", "Loadc4", "Loadc5", "Loadc6", "Loadc7", "Loadc8", "Loadc9", "Loadc10", "Loadc11"};
float loadsPower [] = {22.5, 12.5, 21.5, 12.5, 10, 7, 15, 3, 13, 14.5, 0};
int pins [] = {15, 2, 4, 5, 18, 19, 21, 22, 23, 25, 14};
...
void loop() {
  ...
  while (counter < 1100*60){ //takes one minute to send update
   counter++;
 for (int i =0; i < 11; i++) {
    if (statuses[i]) {
